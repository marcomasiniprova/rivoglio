...
export default function Masthead() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-verde-notte/10 bg-carta/92 backdrop-blur-xl">
      <div className="mx-auto grid h-[62px] max-w-[1216px] grid-cols-[auto_1fr] items-center gap-4 px-5 sm:px-8 lg:grid-cols-[1fr_auto_1fr]">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 xl:min-w-0">
          <Link
            href="/"
        ...
        {/* le azioni */}
        <div className="flex items-center justify-end gap-2 sm:gap-2.5 xl:min-w-0">
