...
export default function Retroattivo() {
  return (
    <section id="retroattivo" className="scroll-mt-24 px-5 py-24 sm:px-8 sm:py-28">
      <div className="mx-auto grid max-w-[1200px] items-center gap-12 lg:grid-cols-[minmax(0,460px)_1fr] lg:gap-20">
        <Anima>
          ...
          <a
            href="#controllo"
            className="riflesso group mt-7 inline-flex items-center gap-2 rounded-bottone bg-verde px-7 py-4 text-[15.5px] font-medium text-white shadow-[0_12px_28px_-12px_rgba(6,122,70,.75),0_2px_0_0_rgba(255,255,255,.22)_inset] transition-all duration-300 hover:-translate-y-0.5 hover:bg-verde-scuro"
          >
            {SEZIONE.cta}
            <span
              aria-hidden="true"
