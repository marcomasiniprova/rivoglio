...
| A3 | 🟡 **La cassa di prova va spenta il giorno del venditore vero** | `CASSA_PROVA_SEGRETO` su Netlify tiene in piedi una cassa che emette **ricevute valide**. Adesso è chiusa a chiave (cookie firmato, solo il browser di Valerio), ma il giorno che arriva un incasso vero quella variabile va **tolta**: senza, la pagina e la rotta smettono di esistere da sole, con la variabile restano una porta in più da sorvegliare. |
